...
export class App extends React.Component {
    ...
    fetchWethear = async () => {
        try {
            if (this.state.location?.length === 0) return this.setState({ err: "" })
            if (this.state.location?.length < 2) return this.setState({ weather: {}, err: "you should write\n\n 2 Letters at least" });
        ...
        return (
            <div className="app">
                ...
                <Input
                    ...
                    onChangeLocation={this.onSetLocation}
                />
